...
{
    /// <inheritdoc />
    public partial class AddQuoteCommentRecipe : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MealType = table.Column<List<string>>(type: "jsonb", nullable: false),
                    Image = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    Rating = table.Column<double>(type: "double precision", precision: 4, scale: 2, nullable: false),
